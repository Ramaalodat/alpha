            ...
            children: [
              ...
              LinearPercentIndicator(
                ...
                backgroundColor: themeprovider.isDark
                    ...
                    : AppColors.lightBorder, // لون الخلفية
                progressColor: themeprovider.isDark
                    ? AppColors.darkSecondary
                    : AppColors.lightSecondary, // لون الشريط
              ...
              OptionChip(
                items: const ["Yes", "No"],
                selected: personalProvider.isHeadOfHousehold == null
                    ? null
                    : personalProvider.isHeadOfHousehold!
                        ? "Yes"
                        : "No",
                onTap: (value) {
                  personalProvider.setHeadOfHousehold(value == "Yes");
                },
              ),
              if (personalProvider.isHeadOfHousehold == false) ...[
                ...
                Text(
                  "Do you contribute to family expenses?",
                  style: TextStyle(
                      fontSize: screenW * 0.04,
                      color: themeprovider.isDark
                          ? AppColors.darkSubText
                ...
                OptionChip(
                  items: const ["Yes", "No"],
                  selected: personalProvider.contributesToExpenses == null
                      ? null
                      : personalProvider.contributesToExpenses!
                          ? "Yes"
                          : "No",
                  onTap: (value) {
                    personalProvider.setContributes(value == "Yes");
                  },
                ),
              ],
              SizedBox(
              ...
              OptionChip(
                items: const ["Yes", "No"],
                selected: personalProvider.isStudent == null
                    ? null
                    : personalProvider.isStudent!
                        ? "Yes"
                        : "No",
                onTap: (value) {
                  personalProvider.setStudent(value == "Yes");
                },
              ),
              SizedBox(
                height: screenH * 0.02,
