...
class _GoalDateScreenState extends State<GoalDateScreen> {
  ...
  void initState() {
    ...
    _selectedDay = widget.initialDate ?? DateTime.now().add(const Duration(days: 30));
              ...
              children: [
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return GestureDetector(
                        ...
                        child: Container(
                          margin: EdgeInsets.symmetric(horizontal: screenW * 0.015),
                ...
                Container(
                  ...
                  child: TableCalendar(
                    ...
                    lastDay: DateTime(DateTime.now().year + 20, 12, 31),
                ...
                Padding(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ButtonStyle(
                      ...
                      fixedSize: WidgetStatePropertyAll(Size(screenW, screenH * 0.065)),
