import { FinancialGoal, GoalTransaction, GoalStatus } from '@prisma/client';
...
export class GoalService {
  ...
  async createGoal(userId: string, data: CreateGoalRequest): Promise<FinancialGoal> {
    const { icon, name, targetAmount, targetDate, flexibility, description, category, priority, goalCategory } = data;
